    ...
    return (
        <>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '0px' }}>
                <h2 style={{ textAlign: 'left', textTransform: 'uppercase', marginTop: '5px', marginBottom: '30px', color: "#832729", fontWeight: "bold", marginRight: '20px', marginLeft: '35px', fontFamily: 'Gill Sans', fontSize: '25px' }}>New Arrivals</h2>
            </div>
